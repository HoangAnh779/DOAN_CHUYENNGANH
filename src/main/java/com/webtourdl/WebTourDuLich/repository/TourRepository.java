...
public interface TourRepository extends JpaRepository<Tour, Long>, JpaSpecificationExecutor<Tour> {
	...
	@Query(value= "SELECT new com.webtourdl.WebTourDuLich.dto.TourDTO(t.id,t.ten_tour,t.gioi_thieu_tour,t.so_ngay,t.noi_dung_tour,t.ngay_ket_thuc,t.ngay_khoi_hanh,t.diem_den,t.loai_tour,t.anh_tour,t.diem_khoi_hanh,t.trang_thai,t.gia_tour, t.giam_gia, t.ma_giam_gia) FROM Tour t "
	...
	@Query("SELECT new com.webtourdl.WebTourDuLich.dto.TourDTO(t.id,t.ten_tour,t.gioi_thieu_tour,t.so_ngay,t.noi_dung_tour,t.ngay_ket_thuc,t.ngay_khoi_hanh,t.diem_den,t.loai_tour,t.anh_tour,t.diem_khoi_hanh,t.trang_thai,t.gia_tour, t.giam_gia, t.ma_giam_gia) FROM Tour t "
			+ " WHERE t.ma_giam_gia = :discountCode AND t.id = :tourId")
	TourDTO findTourByDiscountCodeAndId(@Param("tourId") Long tourId, @Param("discountCode") String discountCode);
}
